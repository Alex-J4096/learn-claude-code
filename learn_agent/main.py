...
TOOLS = [
    ...
    {
    "name": "powershell",
    "description": "Execute a safe PowerShell command for inspecting system information. Only non-destructive commands are allowed, such as Get-Process, Get-ChildItem, or reading logs. Do NOT execute commands that modify the system or run scripts.",
    "input_schema": {
        "type": "object",
        "properties": {"command": {"type": "string",
        "description": "A safe PowerShell command (e.g., Get-Process, Get-ChildItem). Must not include destructive or privileged operations."
                                   }},
        "required": ["command"],
    },
},
...
def run_powershell(command:str) -> str:
    dangerous = ["Remove-Item -Recurse -Force", "Stop-Computer", "Restart-Computer"]
